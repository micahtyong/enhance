...
extension PushupMLVC2 {
    ...
    func onboardingPopup() {
        ...
        let message = "Place your phone a few feet in front of you and get into pushup form.\nPerform \(activity.max) proper pushups.\nUse the color and counter on the screen to guide you! Green means good, red means fix your form."
